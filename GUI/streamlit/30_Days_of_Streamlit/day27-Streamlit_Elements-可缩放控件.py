...
# @Time    : 2023/6/15 0:33
# @Author  : Dreamstar
# @File    : day27-Streamlit_Elements-可缩放控件.py
# @Link    : https://30days.streamlit.app/?challenge=Day27
# @Desc    : Streamlit Elements 是一个由 okld 制作的第三方组件，能够让你用 Material UI 组件、
# @Desc    : Monaco 编辑器（Visual Studio Code）和 Nivo charts 等等搭建出精美的应用和仪表盘。
...
if "data" not in st.session_state:
    st.session_state.data = Path("temp/data.json").read_text()
