...
class AdaRNN(nn.Module):
    ...
    def __init__(self, use_bottleneck=True, bottleneck_width=256, n_input=6,
                 n_hiddens=[64, 64], n_output=6, dropout=0.0, len_seq=24,
                 model_type='AdaRNN', trans_loss='adv'):
        ...
        # mf-模型组网-gate bnlst and softmax
