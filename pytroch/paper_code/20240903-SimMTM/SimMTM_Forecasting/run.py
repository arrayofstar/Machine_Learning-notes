...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_name', type=str, default='finetune',
                        help='task name, options:[pretrain, finetune]')  # required=True,  # 20240820在dataLoader的地方进行了调整
    parser.add_argument('--is_training', type=int, default=1, help='status')
    parser.add_argument('--model_id', type=str, default='SimMTM', help='model id')  # SimMTM  required=True,
    parser.add_argument('--model', type=str, default='SimMTM', help='model name')  # required=True,

    # data loader
    parser.add_argument('--data', type=str, default='ETTh1', help='dataset type')  # required=True,
    parser.add_argument('--root_path', type=str, default='./dataset/ETT-small/',
                        help='root path of the data file')  # ./datasets
    ...
    # forecasting task
    parser.add_argument('--seq_len', type=int, default=128, help='input sequence length')  # 336
    parser.add_argument('--label_len', type=int, default=1, help='start token length')  # 48
    parser.add_argument('--pred_len', type=int, default=127, help='prediction sequence length')  # 96
    ...
    parser.add_argument('--d_model', type=int, default=16, help='dimension of model')  # 32
    parser.add_argument('--n_heads', type=int, default=2, help='num of heads')  # 8
    parser.add_argument('--e_layers', type=int, default=2, help='num of encoder layers')  # 2
    parser.add_argument('--d_layers', type=int, default=1, help='num of decoder layers')
    parser.add_argument('--d_ff', type=int, default=64, help='dimension of fcn')  # 2048
    ...
    # optimization
    parser.add_argument('--num_workers', type=int, default=1, help='data loader num workers')  # 5
    parser.add_argument('--itr', type=int, default=1, help='experiments times')
    parser.add_argument('--train_epochs', type=int, default=5, help='train epochs')  # 10
