...
class RNNModel(nn.Module):
    ...
    def __init__(self, rnn_type, ntoken, ninp, nhid, nlayers, dropout=0.4, dropouth=0.3, dropouti=0.65, dropoute=0.1, wdrop=0, tie_weights=False):
    ...
    def init_hidden(self, bsz):
        ...
        if self.rnn_type == 'LSTM':
            out = [(weight.new(1, bsz, self.nhid if l != self.nlayers - 1 else (
