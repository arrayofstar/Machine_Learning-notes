...
parser.add_argument('--itr', type=int, default=1, help='experiments times')  #  默认值为2
parser.add_argument('--train_epochs', type=int, default=3, help='train epochs')  # 默认值为6
...
parser.add_argument('--inverse', action='store_true', help='inverse output data', default=True)  # 默认值为False
...
data_parser = {
    ...
    'my_data': {'data': 'my_data.csv', 'T': 'AC', 'M': [4, 4, 4], 'S': [1, 1, 1], 'MS': [4, 4, 1]},
}
