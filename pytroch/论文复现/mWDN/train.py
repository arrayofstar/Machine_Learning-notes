...
from utils import plot_results, ToVariable, TorchDataLoader


def train(model, x_train, y_train, epochs=10, batch_size=32, alpha=0.3, beta=0.3, device="cpu"):
...
def test(model, x_test, y_test, data_df_combined_clean, device="cpu"):
